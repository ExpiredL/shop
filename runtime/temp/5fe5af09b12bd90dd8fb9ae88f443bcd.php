<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./oscshop/member\view\checkout\confirm.html";i:1495072598;}*/ ?>
...
$(function(){
	$('#pay').click(function(){
		...
		beforeSend: function() {
			...
			$('#pay').after('<span class="wait">&nbsp;<img src="__PUBLIC__/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
